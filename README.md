...
To deal with transformations between your data space and `bg-atlasapi`, you might find helpful the [brainglobe-space](https://github.com/brainglobe/brainglobe-space) package.
