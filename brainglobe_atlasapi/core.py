...
class Atlas:
    ...
    def hemispheres(self):
        ...
        also synthesized this way when no hemispheres asset is present,
        ...
        # Synthesize when the atlas is symmetric, or when no hemispheres
        # asset exists. The atlas-assets specification defines no such
        # asset, so those atlases always take this branch.
        if self.metadata["symmetric"] or not hemispheres_path.exists():
