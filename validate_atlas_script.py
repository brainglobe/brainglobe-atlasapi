...
assert source_dir.exists(), f"{source_dir} doesn't exist"
if source_dir.exists():
    shutil.copytree(source_dir, destination_dir)
assert destination_dir.exists(), f"{destination_dir} doesn't exist"
...
napari_atlas.add_structure_to_viewer("P")
